...
2. ใส่ชื่อเข้าห้องตัวอย่างบน Mobile แล้วค้นหา/เพิ่มเพลงจากรายการตัวอย่าง
   การค้นหาหนึ่งครั้งจะขอผลลัพธ์สูงสุด 30 เพลงใน request เดียว ไม่มีการโหลดหน้าที่สองเมื่อเลื่อนถึงท้ายรายการ
...
Host เป็นจอแสดงผลอย่างเดียว: ภาพเวทีเต็มกรอบแบบ `cover` และจัดจุดโฟกัสกึ่งกลาง มี QR/ข้อมูลห้องตัวอย่างมุมบนและเพลงถัดไปมุมล่าง ปุ่ม fullscreen ซ่อนหลัง idle 2.5 วินาที เรียกกลับด้วยเมาส์ การแตะ หรือคีย์บอร์ด

...
import { ChevronDown, ChevronUp, ExternalLink, GripVertical, ListMusic, LoaderCircle, Maximize, Menu, Mic2, Music2, Pause, Play, Plus, QrCode, Search, Settings, SkipForward, Trash2, Volume2, Wifi, WifiOff, X } from "lucide-react";
...
function Party({ state, setState, partyToken, onJoined, onExpired }) {
  const [tab, setTab] = useState("search"), [notice, setNotice] = useState(""), [confirmSkip, setConfirmSkip] = useState(false);
